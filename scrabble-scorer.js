...
const scoringAlgorithms = {
  simpleScore: [ 'Simple Score', 'Each letter is worth 1 point.', 'A function with a parameter for user input that returns a score.' ],
  vowelBonusScore: [ 'Bonus Vowels', 'Vowels are 3 pts, consonants are 1pt.', 'A function that returns a score based on the number of vowels and consonants.' ],
  scrabbleScore: [ 'Scrabble', 'The traditional scoring algorithm', 'Uses the oldScrabbleScorer() function to determine the score for a given word.' ]
};
